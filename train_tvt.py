...
import os
import sys
# python -m torch.distributed.launch --nnodes=1 --nproc_per_node=3 --node_rank=0  --master_port=6005 train_tvt.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('-max', '--max_num_iteration', type=int, default=1, help='help')
